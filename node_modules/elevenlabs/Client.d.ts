...
export declare class ElevenLabsClient {
     ...
     */
    claimATaskV1SpeechToTextReviewsTasksTaskIdClaimPost(taskId: string, requestOptions?: ElevenLabsClient.RequestOptions): Promise<unknown>;
    /**
     * @param {string} userId
     ...
     */
    submitACompletedTaskV1SpeechToTextReviewsProducersUserIdTasksTaskIdSubmitPut(userId: string, taskId: string, requestOptions?: ElevenLabsClient.RequestOptions): Promise<unknown>;
    /**
     ...
     *     })
     */
    listUnclaimedReviewsV1SpeechToTextReviewsTasksPost(request: ElevenLabs.ListTasksRequest, requestOptions?: ElevenLabsClient.RequestOptions): Promise<unknown>;
    /**
     * @param {string} userId
     ...
     */
    listTasksInstancesForAUserV1SpeechToTextReviewsProducersUserIdTasksGet(userId: string, request?: ElevenLabs.ListTasksInstancesForAUserV1SpeechToTextReviewsProducersUserIdTasksGetRequest, requestOptions?: ElevenLabsClient.RequestOptions): Promise<ElevenLabs.PaginatedListedReviewTaskInstanceModel>;
    /**
     ...
     *     })
     */
    computeAQuoteForAAsrTranscriptionReviewTaskV1SpeechToTextReviewsGetQuotePost(request: ElevenLabs.QuoteRequestModel, requestOptions?: ElevenLabsClient.RequestOptions): Promise<ElevenLabs.QuoteResponseModel>;
}
