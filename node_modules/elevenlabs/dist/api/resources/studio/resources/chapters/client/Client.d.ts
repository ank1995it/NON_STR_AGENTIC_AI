...
export declare class Chapters {
     ...
     */
    streamSnapshot(projectId: string, chapterId: string, chapterSnapshotId: string, request?: ElevenLabs.studio.BodyStreamChapterAudioV1StudioProjectsProjectIdChaptersChapterIdSnapshotsChapterSnapshotIdStreamPost, requestOptions?: Chapters.RequestOptions): Promise<void>;
}
