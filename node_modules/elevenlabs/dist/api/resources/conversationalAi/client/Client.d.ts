...
export declare class ConversationalAi {
     ...
     */
    getTools(requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.ToolsResponseModel>;
    /**
     ...
     *     })
     */
    addTool(request: ElevenLabs.ToolRequestModel, requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.ToolResponseModel>;
    /**
     ...
     */
    getTool(toolId: string, requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.ToolResponseModel>;
    /**
     ...
     */
    removeTool(toolId: string, requestOptions?: ConversationalAi.RequestOptions): Promise<unknown>;
    /**
     ...
     *     })
     */
    updateTool(toolId: string, request: ElevenLabs.ToolRequestModel, requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.ToolResponseModel>;
    /**
